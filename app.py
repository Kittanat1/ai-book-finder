...
if 'display_books' not in st.session_state:
    st.session_state.display_books = []
...
if not st.session_state.loaded_initial:
    with st.spinner('กำลังโหลดหนังสือและสร้าง IR System...'):
        queries = [
        ...
        # *** แก้ไข: ตั้งค่า display_books ให้แสดงหนังสือทั้งหมดตั้งแต่แรก ***
...
# *** แก้ไข: ลบบรรทัดนี้ออก เพราะเราตั้งค่าไว้ข้างบนแล้ว ***
# if 'display_books' not in st.session_state:
#     st.session_state.display_books = st.session_state.books
